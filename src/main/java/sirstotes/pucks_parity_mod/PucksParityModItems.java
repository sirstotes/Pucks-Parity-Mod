...
public class PucksParityModItems {
    public static void initialize() {
        ...
        DispenserBehavior dispenserBehavior;//Dispenser behavior for placing lava then destroying the bucket.
        DispenserBehavior dispenserBehavior2;//Dispenser behavior for just dispensing liquids
        DispenserBehavior dispenserBehavior3;//Dispenser behavior for just filling liquids
        DispenserBehavior dispenserBehavior4;//Dispenser behavior for filling and emptying liquids
        //? if <1.21.1 {
        dispenserBehavior = new ItemDispenserBehavior() {
            ...
            public ItemStack dispenseSilently(BlockPointer pointer, ItemStack stack) {
                ...
                if (fluidModificationItem.placeFluid((PlayerEntity)null, world, blockPos, (BlockHitResult)null)) {
                    ...
                    return this.fallbackBehavior.dispense(pointer, ItemStack.EMPTY);
                }
            }
        };
        dispenserBehavior2 = new ItemDispenserBehavior() {
            private final ItemDispenserBehavior fallbackBehavior = new ItemDispenserBehavior();
        ...
        dispenserBehavior3 = new ItemDispenserBehavior() {
            private final ItemDispenserBehavior fallbackBehavior = new ItemDispenserBehavior();
        ...
        dispenserBehavior4 = new ItemDispenserBehavior() {
            private final ItemDispenserBehavior fallbackBehavior = new ItemDispenserBehavior();
            @Override
            public ItemStack dispenseSilently(BlockPointer pointer, ItemStack stack) {
                FluidModificationItem fluidModificationItem = (FluidModificationItem)stack.getItem();
                ...
                } else if (fluidModificationItem.placeFluid((PlayerEntity)null, (World) worldAccess, blockPos, (BlockHitResult)null)) {
                    fluidModificationItem.onEmptied((PlayerEntity)null, (World) worldAccess, stack, blockPos);
                    return new ItemStack(Items.BUCKET);
                } else {
                    return this.fallbackBehavior.dispense(pointer, stack);
                }
    ...
    //?if <1.21.1{
    public static final Item COPPER_SHEARS = register(new ShearsItem(new Item.Settings().maxDamage(138)), "copper_shears");
    public static final Item GOLD_SHEARS = register(new ShearsItem(new Item.Settings().maxDamage(200)), "gold_shears");
    //?} else {
    ...
    *///?}
    ...
    //? if <1.21.4 {
    public static final Item COPPER_HORSE_ARMOR = register(new HorseArmorItem(4, "copper", (new Item.Settings()).maxCount(1)), "copper_horse_armor");
    //?} else {
