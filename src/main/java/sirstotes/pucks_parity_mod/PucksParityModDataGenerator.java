...
public class PucksParityModDataGenerator implements DataGeneratorEntrypoint {
	...
	private static class ModelGenerator extends FabricModelProvider {
		...
		public void generateBlockStateModels(BlockStateModelGenerator blockStateModelGenerator) {
			...
			blockStateModelGenerator.registerSimpleCubeAll(PucksParityModBlocks.CRACKED_TUFF_BRICKS);
			blockStateModelGenerator.registerSimpleCubeAll(PucksParityModBlocks.CRACKED_GRANITE_BRICKS);
			blockStateModelGenerator.registerSimpleCubeAll(PucksParityModBlocks.CRACKED_ANDESITE_BRICKS);
			blockStateModelGenerator.registerSimpleCubeAll(PucksParityModBlocks.CRACKED_DIORITE_BRICKS);
			blockStateModelGenerator.registerSimpleCubeAll(PucksParityModBlocks.CRACKED_END_STONE_BRICKS);
			blockStateModelGenerator.registerSimpleCubeAll(PucksParityModBlocks.CRACKED_SANDSTONE_BRICKS);
			blockStateModelGenerator.registerSimpleCubeAll(PucksParityModBlocks.CRACKED_RED_SANDSTONE_BRICKS);
			blockStateModelGenerator.registerSimpleCubeAll(PucksParityModBlocks.CRACKED_PRISMARINE_BRICKS);
			blockStateModelGenerator.registerSimpleCubeAll(PucksParityModBlocks.CRACKED_DARK_PRISMARINE_BRICKS);
			blockStateModelGenerator.registerSimpleCubeAll(PucksParityModBlocks.CRACKED_BASALT_BRICKS);
			blockStateModelGenerator.registerSimpleCubeAll(PucksParityModBlocks.CRACKED_CALCITE_BRICKS);
			blockStateModelGenerator.registerSimpleCubeAll(PucksParityModBlocks.CRACKED_DRIPSTONE_BRICKS);
			blockStateModelGenerator.registerSimpleCubeAll(PucksParityModBlocks.CRACKED_MUD_BRICKS);
			blockStateModelGenerator.registerSimpleCubeAll(PucksParityModBlocks.CRACKED_BRICKS);
			blockStateModelGenerator.registerSimpleCubeAll(PucksParityModBlocks.CRACKED_RED_TERRACOTTA_BRICKS);
			blockStateModelGenerator.registerSimpleCubeAll(PucksParityModBlocks.CRACKED_ORANGE_TERRACOTTA_BRICKS);
			blockStateModelGenerator.registerSimpleCubeAll(PucksParityModBlocks.CRACKED_YELLOW_TERRACOTTA_BRICKS);
			blockStateModelGenerator.registerSimpleCubeAll(PucksParityModBlocks.CRACKED_LIME_TERRACOTTA_BRICKS);
			blockStateModelGenerator.registerSimpleCubeAll(PucksParityModBlocks.CRACKED_GREEN_TERRACOTTA_BRICKS);
			blockStateModelGenerator.registerSimpleCubeAll(PucksParityModBlocks.CRACKED_CYAN_TERRACOTTA_BRICKS);
			blockStateModelGenerator.registerSimpleCubeAll(PucksParityModBlocks.CRACKED_LIGHT_BLUE_TERRACOTTA_BRICKS);
			blockStateModelGenerator.registerSimpleCubeAll(PucksParityModBlocks.CRACKED_BLUE_TERRACOTTA_BRICKS);
			blockStateModelGenerator.registerSimpleCubeAll(PucksParityModBlocks.CRACKED_PURPLE_TERRACOTTA_BRICKS);
			blockStateModelGenerator.registerSimpleCubeAll(PucksParityModBlocks.CRACKED_MAGENTA_TERRACOTTA_BRICKS);
			blockStateModelGenerator.registerSimpleCubeAll(PucksParityModBlocks.CRACKED_PINK_TERRACOTTA_BRICKS);
			blockStateModelGenerator.registerSimpleCubeAll(PucksParityModBlocks.CRACKED_BROWN_TERRACOTTA_BRICKS);
			blockStateModelGenerator.registerSimpleCubeAll(PucksParityModBlocks.CRACKED_WHITE_TERRACOTTA_BRICKS);
			blockStateModelGenerator.registerSimpleCubeAll(PucksParityModBlocks.CRACKED_LIGHT_GRAY_TERRACOTTA_BRICKS);
			blockStateModelGenerator.registerSimpleCubeAll(PucksParityModBlocks.CRACKED_GRAY_TERRACOTTA_BRICKS);
			blockStateModelGenerator.registerSimpleCubeAll(PucksParityModBlocks.CRACKED_BLACK_TERRACOTTA_BRICKS);

			blockStateModelGenerator.registerSimpleCubeAll(PucksParityModBlocks.CRACKED_TUFF_TILES);
			blockStateModelGenerator.registerSimpleCubeAll(PucksParityModBlocks.CRACKED_GRANITE_TILES);
			blockStateModelGenerator.registerSimpleCubeAll(PucksParityModBlocks.CRACKED_ANDESITE_TILES);
			blockStateModelGenerator.registerSimpleCubeAll(PucksParityModBlocks.CRACKED_DIORITE_TILES);
			blockStateModelGenerator.registerSimpleCubeAll(PucksParityModBlocks.CRACKED_END_STONE_TILES);
			blockStateModelGenerator.registerSimpleCubeAll(PucksParityModBlocks.CRACKED_SANDSTONE_TILES);
			blockStateModelGenerator.registerSimpleCubeAll(PucksParityModBlocks.CRACKED_RED_SANDSTONE_TILES);
			blockStateModelGenerator.registerSimpleCubeAll(PucksParityModBlocks.CRACKED_PRISMARINE_TILES);
			blockStateModelGenerator.registerSimpleCubeAll(PucksParityModBlocks.CRACKED_DARK_PRISMARINE_TILES);
			blockStateModelGenerator.registerSimpleCubeAll(PucksParityModBlocks.CRACKED_NETHER_TILES);
			blockStateModelGenerator.registerSimpleCubeAll(PucksParityModBlocks.CRACKED_BASALT_TILES);
			blockStateModelGenerator.registerSimpleCubeAll(PucksParityModBlocks.CRACKED_CALCITE_TILES);
			blockStateModelGenerator.registerSimpleCubeAll(PucksParityModBlocks.CRACKED_DRIPSTONE_TILES);
			blockStateModelGenerator.registerSimpleCubeAll(PucksParityModBlocks.CRACKED_MUD_TILES);
			blockStateModelGenerator.registerSimpleCubeAll(PucksParityModBlocks.CRACKED_TERRACOTTA_TILES);
			blockStateModelGenerator.registerSimpleCubeAll(PucksParityModBlocks.CRACKED_RED_TERRACOTTA_TILES);
			blockStateModelGenerator.registerSimpleCubeAll(PucksParityModBlocks.CRACKED_ORANGE_TERRACOTTA_TILES);
			blockStateModelGenerator.registerSimpleCubeAll(PucksParityModBlocks.CRACKED_YELLOW_TERRACOTTA_TILES);
			blockStateModelGenerator.registerSimpleCubeAll(PucksParityModBlocks.CRACKED_LIME_TERRACOTTA_TILES);
			blockStateModelGenerator.registerSimpleCubeAll(PucksParityModBlocks.CRACKED_GREEN_TERRACOTTA_TILES);
			blockStateModelGenerator.registerSimpleCubeAll(PucksParityModBlocks.CRACKED_CYAN_TERRACOTTA_TILES);
			blockStateModelGenerator.registerSimpleCubeAll(PucksParityModBlocks.CRACKED_LIGHT_BLUE_TERRACOTTA_TILES);
			blockStateModelGenerator.registerSimpleCubeAll(PucksParityModBlocks.CRACKED_BLUE_TERRACOTTA_TILES);
			blockStateModelGenerator.registerSimpleCubeAll(PucksParityModBlocks.CRACKED_PURPLE_TERRACOTTA_TILES);
			blockStateModelGenerator.registerSimpleCubeAll(PucksParityModBlocks.CRACKED_MAGENTA_TERRACOTTA_TILES);
			blockStateModelGenerator.registerSimpleCubeAll(PucksParityModBlocks.CRACKED_PINK_TERRACOTTA_TILES);
			blockStateModelGenerator.registerSimpleCubeAll(PucksParityModBlocks.CRACKED_BROWN_TERRACOTTA_TILES);
			blockStateModelGenerator.registerSimpleCubeAll(PucksParityModBlocks.CRACKED_WHITE_TERRACOTTA_TILES);
			blockStateModelGenerator.registerSimpleCubeAll(PucksParityModBlocks.CRACKED_LIGHT_GRAY_TERRACOTTA_TILES);
			blockStateModelGenerator.registerSimpleCubeAll(PucksParityModBlocks.CRACKED_GRAY_TERRACOTTA_TILES);
			blockStateModelGenerator.registerSimpleCubeAll(PucksParityModBlocks.CRACKED_BLACK_TERRACOTTA_TILES);

			//blockStateModelGenerator.registerSimpleCubeAll(PucksParityModBlocks.CHISELED_GRANITE);
			//blockStateModelGenerator.registerSimpleCubeAll(PucksParityModBlocks.CHISELED_ANDESITE);
			//blockStateModelGenerator.registerSimpleCubeAll(PucksParityModBlocks.CHISELED_DIORITE);
			blockStateModelGenerator.registerSimpleCubeAll(PucksParityModBlocks.CHISELED_END_STONE);
			blockStateModelGenerator.registerSimpleCubeAll(PucksParityModBlocks.CHISELED_PRISMARINE);
			blockStateModelGenerator.registerSimpleCubeAll(PucksParityModBlocks.CHISELED_DARK_PRISMARINE);
			blockStateModelGenerator.registerSimpleCubeAll(PucksParityModBlocks.CHISELED_BASALT);
			blockStateModelGenerator.registerSimpleCubeAll(PucksParityModBlocks.CHISELED_CALCITE);
			blockStateModelGenerator.registerSimpleCubeAll(PucksParityModBlocks.CHISELED_DRIPSTONE);
			blockStateModelGenerator.registerSimpleCubeAll(PucksParityModBlocks.CHISELED_PACKED_MUD);
			blockStateModelGenerator.registerSimpleCubeAll(PucksParityModBlocks.CHISELED_TERRACOTTA);
			blockStateModelGenerator.registerSimpleCubeAll(PucksParityModBlocks.CHISELED_RED_TERRACOTTA);
			blockStateModelGenerator.registerSimpleCubeAll(PucksParityModBlocks.CHISELED_ORANGE_TERRACOTTA);
			blockStateModelGenerator.registerSimpleCubeAll(PucksParityModBlocks.CHISELED_YELLOW_TERRACOTTA);
			blockStateModelGenerator.registerSimpleCubeAll(PucksParityModBlocks.CHISELED_LIME_TERRACOTTA);
			blockStateModelGenerator.registerSimpleCubeAll(PucksParityModBlocks.CHISELED_GREEN_TERRACOTTA);
			blockStateModelGenerator.registerSimpleCubeAll(PucksParityModBlocks.CHISELED_CYAN_TERRACOTTA);
			blockStateModelGenerator.registerSimpleCubeAll(PucksParityModBlocks.CHISELED_LIGHT_BLUE_TERRACOTTA);
			blockStateModelGenerator.registerSimpleCubeAll(PucksParityModBlocks.CHISELED_BLUE_TERRACOTTA);
			blockStateModelGenerator.registerSimpleCubeAll(PucksParityModBlocks.CHISELED_PURPLE_TERRACOTTA);
			blockStateModelGenerator.registerSimpleCubeAll(PucksParityModBlocks.CHISELED_MAGENTA_TERRACOTTA);
			blockStateModelGenerator.registerSimpleCubeAll(PucksParityModBlocks.CHISELED_PINK_TERRACOTTA);
			blockStateModelGenerator.registerSimpleCubeAll(PucksParityModBlocks.CHISELED_BROWN_TERRACOTTA);
			blockStateModelGenerator.registerSimpleCubeAll(PucksParityModBlocks.CHISELED_WHITE_TERRACOTTA);
			blockStateModelGenerator.registerSimpleCubeAll(PucksParityModBlocks.CHISELED_LIGHT_GRAY_TERRACOTTA);
			blockStateModelGenerator.registerSimpleCubeAll(PucksParityModBlocks.CHISELED_GRAY_TERRACOTTA);
			blockStateModelGenerator.registerSimpleCubeAll(PucksParityModBlocks.CHISELED_BLACK_TERRACOTTA);

			blockStateModelGenerator.registerAxisRotated(PucksParityModBlocks.STONE_PILLAR, TexturedModel.CUBE_COLUMN);
			blockStateModelGenerator.registerAxisRotated(PucksParityModBlocks.CHISELED_STONE_PILLAR, TexturedModel.CUBE_COLUMN);
			blockStateModelGenerator.registerAxisRotated(PucksParityModBlocks.TUFF_PILLAR, TexturedModel.CUBE_COLUMN);
			blockStateModelGenerator.registerAxisRotated(PucksParityModBlocks.DEEPSLATE_PILLAR, TexturedModel.CUBE_COLUMN);
			blockStateModelGenerator.registerAxisRotated(PucksParityModBlocks.CHISELED_DEEPSLATE_PILLAR, TexturedModel.CUBE_COLUMN);
			blockStateModelGenerator.registerAxisRotated(PucksParityModBlocks.GRANITE_PILLAR, TexturedModel.CUBE_COLUMN);
			blockStateModelGenerator.registerAxisRotated(PucksParityModBlocks.CHISELED_GRANITE_PILLAR, TexturedModel.CUBE_COLUMN);
			blockStateModelGenerator.registerAxisRotated(PucksParityModBlocks.ANDESITE_PILLAR, TexturedModel.CUBE_COLUMN);
			blockStateModelGenerator.registerAxisRotated(PucksParityModBlocks.CHISELED_ANDESITE_PILLAR, TexturedModel.CUBE_COLUMN);
			blockStateModelGenerator.registerAxisRotated(PucksParityModBlocks.DIORITE_PILLAR, TexturedModel.CUBE_COLUMN);
			blockStateModelGenerator.registerAxisRotated(PucksParityModBlocks.CHISELED_DIORITE_PILLAR, TexturedModel.CUBE_COLUMN);
			blockStateModelGenerator.registerAxisRotated(PucksParityModBlocks.BLACKSTONE_PILLAR, TexturedModel.CUBE_COLUMN);
			blockStateModelGenerator.registerAxisRotated(PucksParityModBlocks.CHISELED_BLACKSTONE_PILLAR, TexturedModel.CUBE_COLUMN);
			blockStateModelGenerator.registerAxisRotated(PucksParityModBlocks.END_STONE_PILLAR, TexturedModel.CUBE_COLUMN);
			blockStateModelGenerator.registerAxisRotated(PucksParityModBlocks.CHISELED_END_STONE_PILLAR, TexturedModel.CUBE_COLUMN);
			blockStateModelGenerator.registerAxisRotated(PucksParityModBlocks.SANDSTONE_PILLAR, TexturedModel.CUBE_COLUMN);
			blockStateModelGenerator.registerAxisRotated(PucksParityModBlocks.CHISELED_SANDSTONE_PILLAR, TexturedModel.CUBE_COLUMN);
			blockStateModelGenerator.registerAxisRotated(PucksParityModBlocks.RED_SANDSTONE_PILLAR, TexturedModel.CUBE_COLUMN);
			blockStateModelGenerator.registerAxisRotated(PucksParityModBlocks.CHISELED_RED_SANDSTONE_PILLAR, TexturedModel.CUBE_COLUMN);
			blockStateModelGenerator.registerAxisRotated(PucksParityModBlocks.PRISMARINE_PILLAR, TexturedModel.CUBE_COLUMN);
			blockStateModelGenerator.registerAxisRotated(PucksParityModBlocks.CHISELED_PRISMARINE_PILLAR, TexturedModel.CUBE_COLUMN);
			blockStateModelGenerator.registerAxisRotated(PucksParityModBlocks.DARK_PRISMARINE_PILLAR, TexturedModel.CUBE_COLUMN);
			blockStateModelGenerator.registerAxisRotated(PucksParityModBlocks.CHISELED_DARK_PRISMARINE_PILLAR, TexturedModel.CUBE_COLUMN);
			blockStateModelGenerator.registerAxisRotated(PucksParityModBlocks.NETHER_PILLAR, TexturedModel.CUBE_COLUMN);
			blockStateModelGenerator.registerAxisRotated(PucksParityModBlocks.CHISELED_NETHER_PILLAR, TexturedModel.CUBE_COLUMN);
			blockStateModelGenerator.registerAxisRotated(PucksParityModBlocks.CHISELED_BASALT_PILLAR, TexturedModel.CUBE_COLUMN);
			blockStateModelGenerator.registerAxisRotated(PucksParityModBlocks.CALCITE_PILLAR, TexturedModel.CUBE_COLUMN);
			blockStateModelGenerator.registerAxisRotated(PucksParityModBlocks.CHISELED_CALCITE_PILLAR, TexturedModel.CUBE_COLUMN);
			blockStateModelGenerator.registerAxisRotated(PucksParityModBlocks.DRIPSTONE_PILLAR, TexturedModel.CUBE_COLUMN);
			blockStateModelGenerator.registerAxisRotated(PucksParityModBlocks.CHISELED_DRIPSTONE_PILLAR, TexturedModel.CUBE_COLUMN);
			blockStateModelGenerator.registerAxisRotated(PucksParityModBlocks.PACKED_MUD_PILLAR, TexturedModel.CUBE_COLUMN);
			blockStateModelGenerator.registerAxisRotated(PucksParityModBlocks.CHISELED_MUD_PILLAR, TexturedModel.CUBE_COLUMN);
			blockStateModelGenerator.registerAxisRotated(PucksParityModBlocks.TERRACOTTA_PILLAR, TexturedModel.CUBE_COLUMN);
			blockStateModelGenerator.registerAxisRotated(PucksParityModBlocks.CHISELED_TERRACOTTA_PILLAR, TexturedModel.CUBE_COLUMN);
			blockStateModelGenerator.registerAxisRotated(PucksParityModBlocks.RED_TERRACOTTA_PILLAR, TexturedModel.CUBE_COLUMN);
			blockStateModelGenerator.registerAxisRotated(PucksParityModBlocks.CHISELED_RED_TERRACOTTA_PILLAR, TexturedModel.CUBE_COLUMN);
			blockStateModelGenerator.registerAxisRotated(PucksParityModBlocks.ORANGE_TERRACOTTA_PILLAR, TexturedModel.CUBE_COLUMN);
			blockStateModelGenerator.registerAxisRotated(PucksParityModBlocks.CHISELED_ORANGE_TERRACOTTA_PILLAR, TexturedModel.CUBE_COLUMN);
			blockStateModelGenerator.registerAxisRotated(PucksParityModBlocks.YELLOW_TERRACOTTA_PILLAR, TexturedModel.CUBE_COLUMN);
			blockStateModelGenerator.registerAxisRotated(PucksParityModBlocks.CHISELED_YELLOW_TERRACOTTA_PILLAR, TexturedModel.CUBE_COLUMN);
			blockStateModelGenerator.registerAxisRotated(PucksParityModBlocks.LIME_TERRACOTTA_PILLAR, TexturedModel.CUBE_COLUMN);
			blockStateModelGenerator.registerAxisRotated(PucksParityModBlocks.CHISELED_LIME_TERRACOTTA_PILLAR, TexturedModel.CUBE_COLUMN);
			blockStateModelGenerator.registerAxisRotated(PucksParityModBlocks.GREEN_TERRACOTTA_PILLAR, TexturedModel.CUBE_COLUMN);
			blockStateModelGenerator.registerAxisRotated(PucksParityModBlocks.CHISELED_GREEN_TERRACOTTA_PILLAR, TexturedModel.CUBE_COLUMN);
			blockStateModelGenerator.registerAxisRotated(PucksParityModBlocks.CYAN_TERRACOTTA_PILLAR, TexturedModel.CUBE_COLUMN);
			blockStateModelGenerator.registerAxisRotated(PucksParityModBlocks.CHISELED_CYAN_TERRACOTTA_PILLAR, TexturedModel.CUBE_COLUMN);
			blockStateModelGenerator.registerAxisRotated(PucksParityModBlocks.LIGHT_BLUE_TERRACOTTA_PILLAR, TexturedModel.CUBE_COLUMN);
			blockStateModelGenerator.registerAxisRotated(PucksParityModBlocks.CHISELED_LIGHT_BLUE_TERRACOTTA_PILLAR, TexturedModel.CUBE_COLUMN);
			blockStateModelGenerator.registerAxisRotated(PucksParityModBlocks.BLUE_TERRACOTTA_PILLAR, TexturedModel.CUBE_COLUMN);
			blockStateModelGenerator.registerAxisRotated(PucksParityModBlocks.CHISELED_BLUE_TERRACOTTA_PILLAR, TexturedModel.CUBE_COLUMN);
			blockStateModelGenerator.registerAxisRotated(PucksParityModBlocks.PURPLE_TERRACOTTA_PILLAR, TexturedModel.CUBE_COLUMN);
			blockStateModelGenerator.registerAxisRotated(PucksParityModBlocks.CHISELED_PURPLE_TERRACOTTA_PILLAR, TexturedModel.CUBE_COLUMN);
			blockStateModelGenerator.registerAxisRotated(PucksParityModBlocks.MAGENTA_TERRACOTTA_PILLAR, TexturedModel.CUBE_COLUMN);
			blockStateModelGenerator.registerAxisRotated(PucksParityModBlocks.CHISELED_MAGENTA_TERRACOTTA_PILLAR, TexturedModel.CUBE_COLUMN);
			blockStateModelGenerator.registerAxisRotated(PucksParityModBlocks.PINK_TERRACOTTA_PILLAR, TexturedModel.CUBE_COLUMN);
			blockStateModelGenerator.registerAxisRotated(PucksParityModBlocks.CHISELED_PINK_TERRACOTTA_PILLAR, TexturedModel.CUBE_COLUMN);
			blockStateModelGenerator.registerAxisRotated(PucksParityModBlocks.BROWN_TERRACOTTA_PILLAR, TexturedModel.CUBE_COLUMN);
			blockStateModelGenerator.registerAxisRotated(PucksParityModBlocks.CHISELED_BROWN_TERRACOTTA_PILLAR, TexturedModel.CUBE_COLUMN);
			blockStateModelGenerator.registerAxisRotated(PucksParityModBlocks.WHITE_TERRACOTTA_PILLAR, TexturedModel.CUBE_COLUMN);
			blockStateModelGenerator.registerAxisRotated(PucksParityModBlocks.CHISELED_WHITE_TERRACOTTA_PILLAR, TexturedModel.CUBE_COLUMN);
			blockStateModelGenerator.registerAxisRotated(PucksParityModBlocks.LIGHT_GRAY_TERRACOTTA_PILLAR, TexturedModel.CUBE_COLUMN);
			blockStateModelGenerator.registerAxisRotated(PucksParityModBlocks.CHISELED_LIGHT_GRAY_TERRACOTTA_PILLAR, TexturedModel.CUBE_COLUMN);
			blockStateModelGenerator.registerAxisRotated(PucksParityModBlocks.GRAY_TERRACOTTA_PILLAR, TexturedModel.CUBE_COLUMN);
			blockStateModelGenerator.registerAxisRotated(PucksParityModBlocks.CHISELED_GRAY_TERRACOTTA_PILLAR, TexturedModel.CUBE_COLUMN);
			blockStateModelGenerator.registerAxisRotated(PucksParityModBlocks.BLACK_TERRACOTTA_PILLAR, TexturedModel.CUBE_COLUMN);
			blockStateModelGenerator.registerAxisRotated(PucksParityModBlocks.CHISELED_BLACK_TERRACOTTA_PILLAR, TexturedModel.CUBE_COLUMN);
		}
